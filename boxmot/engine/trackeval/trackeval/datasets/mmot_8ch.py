...
class mmot_8ch(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': '/path/to/mmot/test/mot',  # Location of GT data
            'IMG_FOLDER': '/path/to/mmot/test/npy',  # Image directory
            'TRACKERS_FOLDER': '/path/to/mmot/results',  # Trackers location
