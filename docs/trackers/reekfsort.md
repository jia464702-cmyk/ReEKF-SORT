...
| `reekfsort_no_virtual` | `false` | `true` | `true` |
| `reekfsort_no_conf` | `true` | `false` | `true` |
| `reekfsort_no_angle` | `true` | `true` | `false` |
| `reekfsort_full` | `true` | `true` | `true` |
...
MOT17 and MOT20 should be reported to show that the changes do not create
large regressions on standard pedestrian benchmarks.
