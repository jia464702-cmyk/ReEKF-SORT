...
- Use `reekfsort` when you need a motion-only tracker designed for non-linear motion, occlusion, and confidence-continuity association. Its paper final default is virtual observation plus confidence cost with angle cost disabled.
