...
_RESOURCE_TRACKER_STDERR = """/path/to/python/cpython-3.12.10/lib/python3.12/multiprocessing/resource_tracker.py:279: UserWarning: resource_tracker: There appear to be 6 leaked semaphore objects to clean up at shutdown
  warnings.warn('resource_tracker: There appear to be %d '
/path/to/python/cpython-3.12.10/lib/python3.12/multiprocessing/resource_tracker.py:292: UserWarning: resource_tracker: '/mp-abc123': [Errno 2] No such file or directory
